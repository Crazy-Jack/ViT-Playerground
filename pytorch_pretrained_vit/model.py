...
class ViT(nn.Module):
    ...
    def forward(self, x, seed=1, which_column=0, which_head=0, save_attention=False):
        ...
        x = self.transformer(x, control_seed=seed, which_column=which_column, which_head=which_head, save_attention=save_attention, fh=fh, fw=fw)  # b,gh*gw+1,d
